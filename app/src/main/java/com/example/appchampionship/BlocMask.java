...
public class BlocMask extends BaseAdapter {

    private Context mContext;
    List<Model> maskList;

    public BlocMask(Context mContext, List<Model> maskList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        @SuppressLint("ViewHolder") View v = View.inflate(mContext,R.layout.activity_bloc_mask,null);
        TextView title = v.findViewById(R.id.tvTitle);
        ImageView Image = v.findViewById(R.id.Image);
        TextView description = v.findViewById(R.id.tvDescription);
        Model maskQuote = maskList.get(position);
